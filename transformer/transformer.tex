...
\node[align=left,text width=4cm] at (36,4,35) {NEGATIVE};
\node[align=left,text width=4cm] at (36,4,36) {NEUTRAL};
\node[align=left,text width=4cm] at (36,4,37) {POSITIVE};
\node[align=left,text width=4cm] at (36,4,38) {NOT APPLICABLE};

\draw [dashed] (30.2,4.1,35) -- node{} (33.9,4.1,35);
\draw [dashed] (30.2,4.1,36) -- node{} (33.9,4.1,36);
\draw [dashed] (30.2,4.1,37) -- node{} (33.9,4.1,37);
